...
- [ ] Decide whether the absorbed service logic should live inside `worker-node` as internal modules or as separate internal workspace packages.
...
- [ ] Define the environment-variable strategy for `worker-node` and any new internal packages created in stage 2.
...
- [ ] Create or update `worker-node/package.json` for monorepo workspace usage.
...
- [ ] Convert the useful request, validation, parsing, and file-save logic into internal module or package exports.
...
- [ ] Add baseline tests for the absorbed ElevenLabs module or package.
...
- [ ] Convert the useful CSV, validation, FFmpeg, and output-generation logic into internal module or package exports.
...
- [ ] Add baseline tests for the absorbed audio module or package.
...
- [ ] Replace child-process execution in `worker-node` with direct internal module or package calls.
...
- [ ] Add or update stage 2 setup and usage documentation for `worker-node` and any new internal packages.
